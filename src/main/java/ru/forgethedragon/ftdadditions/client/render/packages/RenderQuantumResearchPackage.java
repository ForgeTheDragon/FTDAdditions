...
public class RenderQuantumResearchPackage implements IItemRenderer {
    private final ResourceLocation texturePath = new ResourceLocation("ftdadditions:textures/models/quantum_research_package.png");
