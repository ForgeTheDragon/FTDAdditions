...
public class RenderIndustrialResearchPackage implements IItemRenderer {
    private final ResourceLocation texturePath = new ResourceLocation("ftdadditions:textures/models/industrial_research_package.png");
