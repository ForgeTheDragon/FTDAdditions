...
public class RenderAutoResearchPackage implements IItemRenderer {
    private final ResourceLocation texturePath = new ResourceLocation("ftdadditions:textures/models/automation_research_package.png");
