...
public class RubberCrop extends BlockMagicalCrops {
    ...
    public RubberCrop(String name) {
        this.setBlockName(name);
    }

    public Item func_149866_i() {
        return FTDItems.seedsRubber;
    }

    public Item func_149865_P() {
        return FTDItems.essenceRubber;
    }
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        ...
        for (int i = 0; i < this.iconArray.length; ++i) {
            this.iconArray[i] = p_149651_1_.registerIcon("ftdadditions:crop_rubber_" + i);
        }
    }
